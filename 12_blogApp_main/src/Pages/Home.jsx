            ...
            <div>
              ...
              {!authstatus ? (
                <div className="mt-7 flex flex-wrap gap-3">
                  <Link
                    to="/signup"
                    className="px-5 py-3 rounded-xl hover:shadow-2xl duration-500 hover:scale-[1.06] cursor-pointer 0 bg-blue-600 text-white font-semibold hover:bg-blue-700 transition"
                  >
                    Start Writing
                  </Link>
                  ...
                  <Link
                    to="/all-posts"
                    className="px-5 py-3 rounded-xl hover:shadow-2xl duration-500 hover:scale-[1.06] cursor-pointer hover:bg-blue-300 bg-white border border-gray-200 text-gray-800 font-semibold "
                  >
                    Explore Posts
                  </Link>
                ...
                <div className="mt-7 flex flex-wrap gap-3">
                  <Link
                    to="/all-posts"
                    className="px-5 py-3 rounded-xl hover:shadow-2xl duration-500 hover:scale-[1.06] cursor-pointer hover:bg-blue-200 bg-white border border-gray-200 text-gray-800 font-semibold "
                  >
                    Explore Posts
                  </Link>
        ...
        <Container>
          <div className="rounded-2xl bg-gray-900 text-white p-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
           {!authstatus ? (
            ...
            <Link
              to="/signup"
              className="px-6 py-3 rounded-xl hover:shadow-2xl duration-500 hover:scale-[1.06] cursor-pointer h bg-blue-500 text-white font-semibold hover:bg-blue-600 transition"
            >
              Create Account
            </Link>
            </>
            ...
            <><div> 
              <h2 className="text-3xl font-bold">Explore your Blogs.</h2>
              <p className="mt-2 text-white/70 max-w-xl">
                Write freely. Publish confidently. Improve every day.
              </p>
            </div>
            ...
            <Link
              to="/all-posts"
              className="px-6 py-3 rounded-xl hover:shadow-2xl duration-500 hover:scale-[1.06] cursor-pointer  bg-blue-500 text-white font-semibold hover:bg-blue-600 transition"
            >
              Explore Blogs
            </Link>
            </>
